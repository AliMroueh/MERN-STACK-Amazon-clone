...
export default function CartScreen(props) {
    ...
    // params is in react router v6 instead of props.match.params.id
    // const productId = props.match.params.id;
    // this comes through as a string, so when we navigate to "http://.../user?name=john" it will mean that location.search is "?name=john".
    // here we get the quantity from the query string
